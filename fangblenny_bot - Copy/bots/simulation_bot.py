...
PAPER_ACCOUNT_FILE  = DASHBOARD_PUBLIC_DIR / "paper_account.json"
SIM_COOLDOWN_FILE   = DASHBOARD_PUBLIC_DIR / "sim_cooldowns.json"
SIM_LOGS_FILE       = DASHBOARD_PUBLIC_DIR / "sim_logs.json"
SIM_RESULTS_FILE    = DASHBOARD_PUBLIC_DIR / "sim_trade_results.json"
SIM_CONFIG_FILE     = DASHBOARD_PUBLIC_DIR / "sim_config.json"
BOT_LOG_FILE        = SCRIPT_DIR / "bot_trades.json"
...
def execute_sim_setup(result: dict, direction: str) -> bool:
    ...
    with _stop_lock:
        ...
        protection = bot_core.build_trade_protection(price, size, direction)
...
def sim_bot_loop(args) -> None:
    ...
    with _display_lock:
        ...
        while True:
            ...
            dash_enabled = True
            try:
                if SIM_CONFIG_FILE.exists():
                    dash_cfg = json.loads(SIM_CONFIG_FILE.read_text())
            ...
            try:
                ...
                SIM_CONFIG_FILE.write_text(json.dumps(config_data))
            except OSError:
                pass
