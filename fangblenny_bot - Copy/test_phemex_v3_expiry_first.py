...
def test_phemex_v3_expiry_first():
    ...
    # Try formula with EXPIRY FIRST: Expiry + Method + Path + Query + Body
    message = f"{expiry}{method.upper()}{path}{query}{body}"
    ...
    print(f"Testing URL: {url} | Method: {method}")
