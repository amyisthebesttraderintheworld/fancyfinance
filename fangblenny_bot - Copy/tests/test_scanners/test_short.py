"""Tests for scanners.short module."""

import pytest
from unittest.mock import Mock, patch
from fangblenny_bot.scanners.short import analyse, get_tickers, get_candles


class TestAnalyse:
    @patch('fangblenny_bot.scanners.short.pc.get_tickers')
    @patch('fangblenny_bot.scanners.short.pc.get_candles')
    @patch('fangblenny_bot.scanners.short.pc.get_funding_rate_info')
    @patch('fangblenny_bot.scanners.short.pc.get_order_book')
    @patch('fangblenny_bot.scanners.short.pc.get_cryptopanic_news')
    def test_analyse_basic(self, mock_news, mock_order_book, mock_funding, mock_candles, mock_tickers):
        ...
        # Mock order book
        mock_order_book.return_value = (50500, 50600, 0.002, 1000)
