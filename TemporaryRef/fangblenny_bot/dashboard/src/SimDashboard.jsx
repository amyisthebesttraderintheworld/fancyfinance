...
const CSS = /* css */`
  @import url('https://fonts.googleapis.com/css2?family=JetBrains+Mono:ital,wght@400;0,500;0,600;0,700;1,400&display=swap');
  ...
  .sdb-sum-val { font-weight: 700; font-size: 12px; font-variant-numeric: tabular-nums; }
  ...
  .sdb-price-val { color: var(--white); font-variant-numeric: tabular-nums; }
  ...
  .sdb-kv-val  { font-weight: 600; font-variant-numeric: tabular-nums; }
  ...
  .sdb-th-pnl-pos { color: var(--green); font-weight: 700; white-space: nowrap; margin-left: auto; }
  .sdb-th-pnl-neg { color: var(--red);   font-weight: 700; white-space: nowrap; margin-left: auto; }
...
export default function SimDashboard({
  ...
  const poll = useCallback(async () => {
    ...
    const [accR, tradesR, cdR, logsR] = await Promise.allSettled([
      ...
      fetch(`${basePath}/sim_trade_results.json${bust}`).then(r => { if (!r.ok) throw r; return r.json() }),
  ...
  const hasUpnl = positions.some(p => p.mark_price != null)
            ...
            <div className="sdb-panel">
              ...
              <div className="sdb-panel-body">
                ...
                <div className="sdb-kv">
                  ...
                  <span className="sdb-kv-val sdb-muted">N/A</span>
                </div>
                <div className="sdb-kv">
